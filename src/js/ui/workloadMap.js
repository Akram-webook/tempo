...
(function (WP) {
  ...
  // Feedback: the routine Full-time / Freelance pill is clutter on the people page
  // (that distinction lives in the admin view). Only the ACTIONABLE states surface
  // here - Open role and Joining soon; a plain full-time/freelance person shows none.
  ...
  function statusLine(person) {
    ...
    // Routine Full-time / Freelance removed from the card (feedback: pill clutter;
    // that distinction lives in the admin view). Actionable states only above.
    return '';
  }
