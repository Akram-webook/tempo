...
(function (WP) {
   ...
   * (Removed) The full-width Project-delivery entry card at the top of the
   * dashboard. Project delivery is reached from the left nav + its own route. */
  ...
  function render(root) {
    ...
    // (Removed) Project-delivery entry card - reachable from the left nav instead.
