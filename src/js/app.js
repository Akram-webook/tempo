...
(function (WP) {
  ...
  function topbar() {
    ...
    if (canManage) {
      ...
      // reporting-for-its-own-sake, which the app deliberately avoids (Constitution I:
      // improve decisions, not reporting). The route + view + weeklyReport.js are kept
      // intact and reachable, so restoring it is a one-line nav.push here.
