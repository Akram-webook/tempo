...
(function (WP) {
   ...
   * separately (must be @example.com). Default: current team is granted; an admin
  ...
  // "all non-tbc granted" line. Domain (@example.com) + identity are still enforced separately.
