 ...
 * SYNChronous impl keeps auth simple and byte-identical to the Node-side build hash.
 *
 * Standard SHA-256 (FIPS 180-4), UTF-8 input, lowercase-hex output. Stateless per call.
 * ========================================================== */
(function (WP) {
  'use strict';
  ...
  function sha256(str) {
    ...
    for (let i = 7; i >= 0; i--) bytes.push((i < 4) ? (bitLen >>> (i * 8)) & 0xff : 0);
