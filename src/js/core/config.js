...
(function (WP) {
  ...
  // NOTE: the Executive Status Deck lives OUTSIDE this app — it's a standalone,
  // auto-updating Google Slides deck generated by an Apps Script bound to the
  // Tempo Feedback Sheet (director-only link). Nothing in the app renders it.
